...
@section('navigation')
<h3><i class="fas fa-tachometer-alt"></i>Addmin Dashboard<small> Edit User</small></h3><hr>
<ol class="breadcrumb">
    <li><i class="fas fa-tachometer-alt"></i>admin dashboard</li>
 ...
 <div class="row">
	<div class="col-md-9 col-md-offset-1">
		...
		<div class="text-center"><h3>Edit User</h3></div>
			...
			<form method="post" action="{{route('admin-account.update',$user->id)}}" class="forms-sample" enctype="multipart/form-data"> 
				{{csrf_field()}}
