...
@section('navigation')
<h3><i class="fas fa-tachometer-alt"></i>Admin Dashboard<small> Edit Your Product</small></h3><hr>
<ol class="breadcrumb">
 ...
 <div class="row">
	<div class="col-md-9 col-md-offset-1">
		...
		<div class="text-center"><h3>Edit product</h3></div><br>
			...
			<form method="post" action="{{route('admin-news.update',$new->id)}}" class="forms-sample" enctype="multipart/form-data"> 
				{{csrf_field()}}
