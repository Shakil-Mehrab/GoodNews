@php 
use App\Model\News;
        $district_news=News::orderBY('id','desc')->where('category_id',8)->limit(6)->get(); 
@endphp
<div class="col-md-12">
...
<div class="activity">
  <span class="views">{{$politic->views()}}</span>
  <span class="comment"><a>{{$politic->comments()->count()}}</a></span>
</div>
