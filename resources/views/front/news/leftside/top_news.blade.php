...
<div class="activity">
  <span class="views">{{$top_new->views()}}</span>
  <span class="comment"><a>{{$top_new->comments()->count()}}</a></span>
</div>
		</div>
	</article><!--  /.post -->
@empty
...
<div class="activity">
  <span class="views">{{$latest_new->views()}}</span>
  <span class="comment"><a>{{$latest_new->comments()->count()}}</a></span>
</div>
