...
<div class="activity">
  <span class="views">{{$sport_latest_new->views()}}</span>
  <span class="comment"><a>{{$sport_latest_new->comments()->count()}}</a></span>
</div>
...
<div class="activity">
  <span class="views">{{$sport_new->views()}}</span>
  <span class="comment"><a>{{$sport_new->comments()->count()}}</a></span>
</div>
