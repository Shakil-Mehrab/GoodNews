...
<div class="featured-posts gn-animation" data-animation="fadeInUp" data-animation-delay="0" data-animation-offset="75%">
	<div class="content">
	@forelse($international_news_top as $national_new)
	<article class="post">
			<div class="thumb">
...
<div class="highlights-posts gn-animation" data-animation="fadeInUp" data-animation-delay="0" data-animation-offset="75%">
	...
	@forelse($international_news as $national_new)
	@if($national_new->id%2==0)
	<article class="post">
		<div class="thumb">
		<a href="{{URL::to($national_new->image)}}">
				<img  src="{{URL::to($national_new->image)}}" class="national thumbnail" alt="img">
				</a>
		</div>
		<div class="cat">
 ...
 <div class="text-center">{!! $international_news->links(); !!}</div>				
@endsection
