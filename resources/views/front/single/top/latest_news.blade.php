@extends('layouts.master')
 @section('leftside')
				...
				<div class="featured-posts gn-animation" data-animation="fadeInUp" data-animation-delay="0" data-animation-offset="75%">
						<div class="content">
						@forelse($latest_news_top as $national_new)
						<?php
						Session::put('latest_new_top_id',$national_new->id);
					   ?>
						<article class="post">
								<div class="thumb">
				...
				<div class="highlights-posts gn-animation" data-animation="fadeInUp" data-animation-delay="0" data-animation-offset="75%">
						...
						@forelse($latest_news_mid as $national_new)
						@if($national_new->id%2==0)
						<?php
						Session::put('latest_new_mid_id',$national_new->id);
					   ?>
						<article class="post">
							<div class="thumb">
							<a href="{{URL::to($national_new->image)}}">
							...
							<div class="content-wrapper">
										...
										<div class="card-body">
											...
											<div class="col-12">
												...
												<tbody>
													@forelse($latest_news as $national_new)
													<tr>
														<td>
														<article class="post">
															<div class="thumb">
