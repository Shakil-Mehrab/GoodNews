@extends('layouts.master')
 @section('leftside')
				...
				<div class="featured-posts gn-animation" data-animation="fadeInUp" data-animation-delay="0" data-animation-offset="75%">
						<div class="content">
						@forelse($life_style_news_top as $national_new)
						<?php
						Session::put('life_style_new_top_id',$national_new->id);
					   ?>
						<article class="post">
								<div class="thumb">
				...
				<div class="highlights-posts gn-animation" data-animation="fadeInUp" data-animation-delay="0" data-animation-offset="75%">
						...
						<div class="section-title">
							<h4><a href="{{route('national.index')}}">Science & Technology</a></h4>
						</div>
					
						@forelse($life_style_news_mid as $national_new)
						@if($national_new->id%2==0)
						<?php
						Session::put('life_style_new_mid_id',$national_new->id);
					   ?>
						<article class="post">
							<div class="thumb">
							<a href="{{URL::to($national_new->image)}}">
							...
							<div class="content-wrapper">
										...
										<div class="card-body">
											...
											<div class="col-12">
												...
												<tbody>
													@forelse($life_style_news as $national_new)
													<tr>
														<td>
														<article class="post">
															<div class="thumb">
