...
@section('navigation')
<h3><i class="fas fa-tachometer-alt"></i> Dashboard<small> View Users</small></h3><hr>
<ol class="breadcrumb">
                    ...
                    <table id="order-listing" class="table table-striped" style="width:100%;">
                      ...
                      <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{$user->author}}</td>
                            <td> <a href="{{route('user.show',$user->id)}}"><span style="color:green"><i class="far fa-eye"></i></span></a></td>
                            <td><a href="{{route('user.destroy',$user->id)}}" id="delete" ><span style="color:#DD4F43"><i class="fas fa-trash-alt"></i></span></a></td>
                         </tr>
                        @empty
                        <tr>
                            <td><h4></h4></td>
