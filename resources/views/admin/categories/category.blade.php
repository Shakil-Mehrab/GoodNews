...
@section('navigation')
<h3><i class="fas fa-tachometer-alt"></i> Dashboard<small> View Your Category</small></h3><hr>
<ol class="breadcrumb">
                   ...
                   <section>
                        ...
                        <table class="table table-hover table-striped table-bordered">
                            ...
                            <tr>
                                ...
                                <td><a href="{{route('category.delete',$category->id)}}"><span style="color:#DD4F43"><i class="fas fa-trash-alt"></i></span></a></td>       
...
<div id="mymodal" class="modal fade" tabindex="-1" role="dialog" >
        <div class="modal-dialog" role="document">
              <form method="post" action="{{route('categories.store')}}" class="forms-sample" enctype="multipart/form-data"> 
                  {{csrf_field()}}
          <div class="modal-content">
            <div class="modal-header">
              <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
